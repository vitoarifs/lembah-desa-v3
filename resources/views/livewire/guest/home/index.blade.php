...
<section class="relative pt-24 sm:pt-28 lg:pt-32 pb-10 sm:pb-12 lg:pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
    ...
    <!-- H1 -->
    <h1 class="font-serif text-3xl sm:text-4xl lg:text-[40px] font-bold tracking-tight text-stone-100 max-w-4xl mx-auto leading-tight">
        Menyatu dengan Alam,
        <span class="text-amber-500 italic">Merayakan Rasa</span>
    </h1>

    <!-- Hero Description -->
    <p class="mt-4 sm:mt-5 text-stone-300 text-sm sm:text-[15px] lg:text-base max-w-2xl mx-auto leading-relaxed">
    ...
    <!-- Hero Image -->
    <div class="mt-8 sm:mt-10 lg:mt-12 max-w-5xl mx-auto rounded-2xl overflow-hidden border border-stone-800 shadow-2xl shadow-black/60">
        <img
...
<!-- =========================================================
     2. SOCIAL PROOF SINGKAT
     ========================================================= -->
<section class="border-y border-stone-800/80 bg-stone-950 py-5 sm:py-7 px-4 sm:px-6 lg:px-8">

    <div class="max-w-6xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 lg:gap-6 text-center">

        <!-- 1. Rating Google -->
        <div class="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl bg-stone-900/40 border border-stone-800/50">
            ...
            <div class="flex text-amber-400 mb-1.5">
                ...
                <svg class="w-4 h-4 fill-current" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0 1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                </svg>
                <svg class="w-4 h-4 fill-current" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                </svg>
            ...
            <span class="font-bold text-stone-100 text-sm lg:text-[15px]">
                4.8 / 5.0
            </span>

            <span class="text-stone-400 text-xs lg:text-[13px] mt-0.5">
                1,200+ Ulasan Google
            </span>
        ...
        <div class="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl bg-stone-900/40 border border-stone-800/50">
            ...
            <span class="font-bold text-amber-400 text-base lg:text-[17px]">
                Rp 5.000
            </span>

            <span class="text-stone-300 font-medium text-xs lg:text-[13px] mt-0.5">
                HTM Terjangkau
            </span>
...
<section class="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 lg:gap-7">
        ...
        <div class="bg-stone-900 border border-stone-800/80 rounded-xl sm:rounded-2xl overflow-hidden hover:border-stone-700 transition-colors group">
            ...
            <div class="p-5 sm:p-6">
                ...
                <div class="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-amber-500/10 text-amber-400 flex items-center justify-center mb-3">
        ...
        <div class="bg-stone-900 border border-stone-800/80 rounded-xl sm:rounded-2xl overflow-hidden hover:border-stone-700 transition-colors group">
            ...
            <div class="p-5 sm:p-6">
                ...
                <div class="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-amber-500/10 text-amber-400 flex items-center justify-center mb-3">
                    ...
                    <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 9a2 2 0 012-2h0.93a2 2 0 001.664-.89l0.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l0.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/>
...
<!-- =========================================================
     4. TENTANG KAMI
     ========================================================= -->
<section class="py-12 sm:py-16 lg:py-20 bg-stone-900/50 border-y border-stone-800/60 px-4 sm:px-6 lg:px-8">

    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-14 items-center">
...
<section class="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    ...
    <div class="text-center max-w-2xl mx-auto mb-8 sm:mb-10 lg:mb-12">
        ...
        <h2 class="font-serif text-3xl sm:text-4xl lg:text-[40px] font-bold text-stone-100 mt-1.5 sm:mt-2 leading-tight">
            Kesan Dari Mereka
        </h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 lg:gap-7">
        ...
        <div class="bg-stone-900 border border-stone-800 p-5 sm:p-6 lg:p-7 rounded-xl sm:rounded-2xl flex flex-col justify-between">
            ...
            <div>
                ...
                <h4 class="font-bold text-stone-100 text-sm lg:text-[15px]">
                    Budi Santoso
                </h4>

                <span class="text-stone-500 text-xs lg:text-[13px]">
...
<!-- =========================================================
     6. FINAL CTA
     ========================================================= -->
<section class="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-emerald-950 border-t border-emerald-900/50">
