        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                            ...
                            <p class="flex items-start gap-3">
                                ...
                                >
                                    <path
                                        ...
                                        stroke-linejoin="round"
                                        stroke-width="2"
                                        d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 001 1.71l.29.13a2 2 0 010 3.42l-.29.13A2 2 0 003 17v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 00-1-1.71l-.29-.13A2 2 0 0021 10V7a2 2 0 00-2-2H5z"
                                    />
                                </svg>
            ...
            @empty
                ...
                <div class="col-span-full py-12 text-center">
                    ...
                    <p class="text-sm lg:text-[15px] text-stone-500">
