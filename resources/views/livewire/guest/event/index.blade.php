<section class="bg-stone-950 text-stone-100 font-sans min-h-screen py-12 lg:py-20 px-4 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto space-y-8">
    ...
    <!-- Header Halaman -->
    <div class="border-b border-stone-800 pb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
      <div>
        <span class="text-amber-500 font-medium text-xs tracking-widest uppercase">Agenda & Kegiatan</span>
        <h1 class="font-serif text-3xl sm:text-4xl font-bold text-stone-100 mt-1">Acara di Lembah Desa</h1>
      </div>
      <p class="text-stone-400 text-sm max-w-md leading-relaxed">
        Jadwal kegiatan rutin, festival kuliner, dan acara spesial. Terbuka untuk umum maupun reservasi khusus.
      </p>
    </div>
    ...
    <!-- Grid Card Event: 1 Kolom Mobile, 2 Kolom Tablet, 3 Kolom Desktop -->
    ...
    @foreach ($dummyEvents as $event)
        ...
        >
            <div class="p-5 sm:p-6">
                ...
                {{-- Judul --}}
                <h2 class="font-serif text-xl font-bold text-stone-100 leading-snug line-clamp-2">
                    {{ $event['judul'] }}
                </h2>

                {{-- Detail --}}
                <div class="mt-5 space-y-3 text-sm text-stone-400">
                ...
                {{-- Deskripsi --}}
                <p class="mt-5 pt-4 border-t border-stone-800 text-sm text-stone-400 leading-relaxed line-clamp-3">
                    {{ $event['deskripsi'] }}
                </p>
            ...
            {{-- Footer --}}
<div class="mt-auto px-5 sm:px-6 py-4 border-t border-stone-800">
    <a
    ...
    >
        ...
        <span>Tanyakan Acara Ini via WhatsApp</span>
    </a>
</div>
