<div>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-bold text-gray-800 leading-tight">Tambah Kategori Kuliner</h2>
                <p class="text-xs text-gray-500 mt-1">Buat kategori baru untuk mengelompokkan menu</p>
            </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
            <form wire:submit.prevent="store" class="space-y-4">
                <div>
                    ...
                    <input type="text" wire:model.live="nama" class="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-xs text-gray-900 focus:ring-2 focus:ring-amber-500" placeholder="Contoh: Minuman Tradisional">
                ...
                <div class="pt-4 border-t border-gray-100 flex items-center justify-end gap-2">
                    ...
                    <button type="submit" class="px-4 py-2 bg-amber-600 hover:bg-amber-500 text-white text-xs font-semibold rounded-lg shadow-sm transition">Simpan Kategori</button>
                </div>
            </form>
        </div>
    </div>
